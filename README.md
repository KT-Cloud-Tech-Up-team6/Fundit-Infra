...
- 개발 EC2 배포용 GitOps OIDC Role과 전용 SSM 문서도 bootstrap에서 관리한다. [GitOps 개발 배포](./docs/gitops-dev-deploy.md)에 권한 경계와 서버 준비·활성화 순서를 정리했다.
...
- [`docs/gitops-dev-deploy.md`](./docs/gitops-dev-deploy.md) GitOps 개발 EC2 배포 인증과 SSM·서버 준비 계약
